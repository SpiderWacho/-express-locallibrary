...
exports.book_create_get = asyncHandler(async (req, res, next) => {
  // Get all aauthros and genres, which we can use for adding to our book.
...
exports.book_create_post = [
  ...
  asyncHandler(async (req, res, next) => {
    ...
    // Create a Book object with escped and trimmed data.
    const book = new Book({
...
exports.book_delete_post = asyncHandler(async (req, res, next) => {
  ...
  if (book_instances.length > 0) {
    ...
    // Book has no bookInstances associated. Delete object and rediret to the list of books.
